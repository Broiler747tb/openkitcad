...
- Device-side `OfflineSmokeTest`: **309/309** bundled JS/kernel assertions passed, workspace WebGL canvas and pen toolbar became ready, INTERNET permission absent. The suite is now 1047 checks, so this number will change when the test is next run.
